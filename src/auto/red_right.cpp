...
void Red::right() {
    ...
    chassis.setPose(-58, -9, -90);
    chassis.turnToPoint(-68, 0,1000);
    pros::delay(200);
    subsystem::arm.pid_arm(Arm::position::MID, 200, 1, 100);

    
    chassis.moveToPoint(-46, -20,1200,{.forwards=false,.maxSpeed=100},true);
   ...
   chassis.turnToHeading(-60,600);
    ...
    chassis.moveToPoint(-23.5, -23.5,2200,{.forwards=false,.maxSpeed=70},false);
    ...
    chassis.turnToPoint(-21.5, -47.5,2000);
    chassis.moveToPoint(-21.5, -47.5,2000,{.forwards=true,.maxSpeed=100},false);

    pros::delay(300);

    chassis.swingToPoint(-12.5, -12.5, DriveSide::RIGHT, 1200);
